...
class email{
    ...
    public static function sendCustomerEmail($cust_id, $template){
        global $DIR;
        ...
        $message .="<hr /><p>If you have received this message in error, please let us know immediately by replying to this email or calling 213-740-3575. We apologize for any inconvenience.</p>";
